...
*/
  ...
  if(jtok1 = obj["Segment"])
  {
    ...
    SEGMENT_I(segment_index).start = data[1];
    SEGMENT_I(segment_index).stop = data[2];
...
#ifdef ENABLE_DEVFEATURE_LIGHTS__WLED_CONFIG_READ_SAVE
...
#endif // ENABLE_DEVFEATURE_LIGHTS__WLED_CONFIG_READ_SAVE
